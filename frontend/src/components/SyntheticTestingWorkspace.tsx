...
import {
    ...
    ChevronDown, ChevronUp, Maximize2, Edit2, Save
} from 'lucide-react';
import {
                                ...
                                <ResponsiveContainer width="100%" height="100%">
                                    <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                                        ...
                                        <XAxis
                                            ...
                                            domain={[1, 7]}
                                            tickCount={7}
                                            label={{ value: getMetricLabel(xAxisMetric), position: 'bottom', offset: 0 }}
                                        />
                                        <YAxis
                                            type="number"
                                            dataKey="y"
                                            ...
                                            domain={[1, 7]}
                                            tickCount={7}
                                            label={{ value: getMetricLabel(yAxisMetric), angle: -90, position: 'insideLeft' }}
                                        />
